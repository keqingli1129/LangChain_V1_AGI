...
# 本目录为 13_AgentAPIServerWithStreaming，在 12 基础上增加流式输出，端口与日志独立
class Config:
    # 配置日志文件路径（与 12 区分）
    LOG_FILE = "logfile/app_13.log"
    ...
    # FastAPI 接口服务器参数（与 12 不同端口，可同时运行）
    API_SERVER_HOST = "0.0.0.0"
    API_SERVER_PORT = 8202
    API_BASE_URL = "http://localhost:8202"

    # Gradio 前端端口（与 12 的 7861 区分）
    GRADIO_PORT = 7862
